                                ...
                                <?php $wp_query = new WP_Query( $args ); ?>
                                    ...
                                    <?php if (have_posts()): ?>
                                        ...
                                        <?php if (has_post_thumbnail()): ?>
                                                <figure data-aos="fade-in"><?php the_post_thumbnail( "post-thumbnail" ); ?></figure>
                                            <?php else: ?>
                                                <figure data-aos="fade-in"><img src='<?php echo get_template_directory_uri(); ?>/img/no-image.jpg' alt='no-image'></figure>
                                            <?php endif; ?>
                                            <h2><?php the_title(); ?></h2>
                                            <p>
                                                <?php the_excerpt(); ?>
